This is an extension to the Activity Stream Module, so you will have to download install and enable that module first.  It can be downloaded here http://drupal.org/project/activitystream
